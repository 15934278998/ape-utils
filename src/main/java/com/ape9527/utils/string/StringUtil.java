package com.ape9527.utils.string;

import com.ape9527.utils.date.DateUtil;
...
public class StringUtil extends org.apache.commons.lang3.StringUtils {
     ...
     * @return 处理后的文件名
     */
    public static String fileNameAddTimestamp(String fileName) {
        if (isEmpty(fileName)) {
            return "";
        }
        String firstName = fileName.substring(0, fileName.lastIndexOf("."));
        String listName = fileName.substring(fileName.lastIndexOf("."));
        long time = DateUtil.getNowDate().getTime();
        return firstName + "-" + time + listName;
    }
    ...
    public static String listToString(List<String> list, String space) {
        ...
        return res.substring(0,res.lastIndexOf(space));
    }
